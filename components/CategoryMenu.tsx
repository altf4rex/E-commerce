...
export default function CategoryMenu() {
  return (
    <div className="scr flex py-2 justify-between px-[45px] mx-[-45px] bg-primaryBg max-xl:mx-2 max-xl:px-2 max-xl:bg-inherit max-xl:justify-start max-xl:overflow-auto">
        {categories.map((c) => (
