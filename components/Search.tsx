...
const defaultSearcchParams = searchParams.get("search") ?? "";
  ...
  return (
    <form onSubmit={onSubmit} className='flex max-lg:w-[100%] max-lg:mx-6 max-sm:mx-1 bg-primaryBg border border-gray-300 rounded-2xl'>
      <input id="search" type="search" name="search" className='w-[262px] max-lg:w-[100%] p-3 text-sans text-sm text-gray-700 bg-primaryBg rounded-2xl outline-none' defaultValue={defaultSearcchParams} placeholder='Search Products, categories ...'/>
